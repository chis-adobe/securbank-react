        ...
        <ul className="articleList">
            {articles && articles.map((article, index) => (
                <li key={index} data-aue-resource={"urn:aemconnection:" + article._path + "/jcr:content/data/master"} data-aue-type="reference" data-aue-filter="cf">
                    <img data-aue-prop="heroImage" data-aue-type="media" className="articleImage" alt="decorative" src={aempublishurl + (article.heroImage._dynamicUrl || article.heroImage._publishUrl) + "&width=470"} />
