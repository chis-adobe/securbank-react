export default async function FetchOffers() {
    ...
    //const aemurl = process.env.REACT_APP_OFFERPERSISTEDQUERY_URL + `?ts=${Math.random()*1000}`;
    const aemurl = process.env.REACT_APP_ADVENTUREQUERY_URL + `?ts=${Math.random()*1000}`;
